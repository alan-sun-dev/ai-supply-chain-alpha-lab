...
## 1. Executive Summary
- A2 strategy at **0 bps** (gross): CAGR `120.93%`, Sharpe `2.070`, max DD `-27.04%`, final NAV `101.885`.
- At **100 bps** (highest cost tested): CAGR `107.39%`, Sharpe `1.912`, final NAV `70.461`.
- **0050.TW benchmark**: CAGR `30.24%`, Sharpe `1.275`, max DD `-29.19%`.
- **Break-even one-way cost: ~812 bps** (strategy net CAGR equals benchmark CAGR at this cost).
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 120.93% | 2.070 | 43.56% | -27.04% | 72.86% | 55.43% | 0.00% | 101.885 | 90.19% |
| 10 | 119.54% | 2.054 | 43.57% | -27.33% | 72.86% | 55.43% | 0.67% | 98.206 | 88.80% |
| 25 | 117.47% | 2.031 | 43.59% | -27.77% | 72.86% | 55.43% | 1.66% | 92.931 | 86.74% |
| 50 | 114.06% | 1.991 | 43.62% | -28.49% | 72.86% | 55.43% | 3.33% | 84.752 | 83.33% |
| 100 | 107.39% | 1.912 | 43.69% | -29.92% | 72.86% | 55.43% | 6.65% | 70.461 | 76.66% |
...
Binary-search result: **811.8 bps** (net CAGR equals benchmark `30.24%` at this cost).

Interpretation:
- A break-even of **812 bps** is well above realistic Taiwan retail costs (60-90 bps round-trip in this convention) and far above institutional desks (25-50 bps). The strategy retains positive net alpha at any plausible cost level.

## 7. Turnover Analysis
- Average monthly one-way turnover: **55.43%** (top-5 EW)
- Annualized: **6.65×** (665% of portfolio rotated per year)
...
- **0 bps** → net CAGR 120.93% (90.19% vs benchmark) — still beats benchmark with healthy margin.
- **10 bps** → net CAGR 119.54% (88.80% vs benchmark) — still beats benchmark with healthy margin.
- **25 bps** → net CAGR 117.47% (86.74% vs benchmark) — still beats benchmark with healthy margin.
- **50 bps** → net CAGR 114.06% (83.33% vs benchmark) — still beats benchmark with healthy margin.
- **100 bps** → net CAGR 107.39% (76.66% vs benchmark) — still beats benchmark with healthy margin.
